...
export function getDoctors(options?: ExecuteQueryOptions): QueryPromise<GetDoctorsData, undefined>;
export function getDoctors(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<GetDoctorsData, undefined>;
...
export function getPatientsByDoctor(vars: GetPatientsByDoctorVariables, options?: ExecuteQueryOptions): QueryPromise<GetPatientsByDoctorData, GetPatientsByDoctorVariables>;
export function getPatientsByDoctor(dc: DataConnect, vars: GetPatientsByDoctorVariables, options?: ExecuteQueryOptions): QueryPromise<GetPatientsByDoctorData, GetPatientsByDoctorVariables>;
...
export function getAppointments(options?: ExecuteQueryOptions): QueryPromise<GetAppointmentsData, undefined>;
export function getAppointments(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<GetAppointmentsData, undefined>;
...
export function getAiDiagnoses(options?: ExecuteQueryOptions): QueryPromise<GetAiDiagnosesData, undefined>;
export function getAiDiagnoses(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<GetAiDiagnosesData, undefined>;
...
export function getLandingWorkspace(options?: ExecuteQueryOptions): QueryPromise<GetLandingWorkspaceData, undefined>;
export function getLandingWorkspace(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<GetLandingWorkspaceData, undefined>;
...
export function getZaloContacts(options?: ExecuteQueryOptions): QueryPromise<GetZaloContactsData, undefined>;
export function getZaloContacts(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<GetZaloContactsData, undefined>;
...
export function getDashboardHomeWorkspace(vars: GetDashboardHomeWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetDashboardHomeWorkspaceData, GetDashboardHomeWorkspaceVariables>;
export function getDashboardHomeWorkspace(dc: DataConnect, vars: GetDashboardHomeWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetDashboardHomeWorkspaceData, GetDashboardHomeWorkspaceVariables>;
...
export function getPatientWorkspace(vars: GetPatientWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetPatientWorkspaceData, GetPatientWorkspaceVariables>;
export function getPatientWorkspace(dc: DataConnect, vars: GetPatientWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetPatientWorkspaceData, GetPatientWorkspaceVariables>;
...
export function getScheduleWorkspace(vars: GetScheduleWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetScheduleWorkspaceData, GetScheduleWorkspaceVariables>;
export function getScheduleWorkspace(dc: DataConnect, vars: GetScheduleWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetScheduleWorkspaceData, GetScheduleWorkspaceVariables>;
...
export function getConsultationWorkspace(vars: GetConsultationWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetConsultationWorkspaceData, GetConsultationWorkspaceVariables>;
export function getConsultationWorkspace(dc: DataConnect, vars: GetConsultationWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetConsultationWorkspaceData, GetConsultationWorkspaceVariables>;
...
export function getAiDiagnosisWorkspace(vars: GetAiDiagnosisWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetAiDiagnosisWorkspaceData, GetAiDiagnosisWorkspaceVariables>;
export function getAiDiagnosisWorkspace(dc: DataConnect, vars: GetAiDiagnosisWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetAiDiagnosisWorkspaceData, GetAiDiagnosisWorkspaceVariables>;
...
export function getPharmacyWorkspace(vars: GetPharmacyWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetPharmacyWorkspaceData, GetPharmacyWorkspaceVariables>;
export function getPharmacyWorkspace(dc: DataConnect, vars: GetPharmacyWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetPharmacyWorkspaceData, GetPharmacyWorkspaceVariables>;
...
export function getReportsWorkspace(options?: ExecuteQueryOptions): QueryPromise<GetReportsWorkspaceData, undefined>;
export function getReportsWorkspace(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<GetReportsWorkspaceData, undefined>;
...
export function getDoctorProfileWorkspace(vars: GetDoctorProfileWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetDoctorProfileWorkspaceData, GetDoctorProfileWorkspaceVariables>;
export function getDoctorProfileWorkspace(dc: DataConnect, vars: GetDoctorProfileWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetDoctorProfileWorkspaceData, GetDoctorProfileWorkspaceVariables>;
...
export function getSettingsWorkspace(vars: GetSettingsWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetSettingsWorkspaceData, GetSettingsWorkspaceVariables>;
export function getSettingsWorkspace(dc: DataConnect, vars: GetSettingsWorkspaceVariables, options?: ExecuteQueryOptions): QueryPromise<GetSettingsWorkspaceData, GetSettingsWorkspaceVariables>;
...
export function getRecordDigitizationWorkspace(options?: ExecuteQueryOptions): QueryPromise<GetRecordDigitizationWorkspaceData, undefined>;
export function getRecordDigitizationWorkspace(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<GetRecordDigitizationWorkspaceData, undefined>;
